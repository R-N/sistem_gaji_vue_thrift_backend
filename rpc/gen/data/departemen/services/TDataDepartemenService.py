...
class Client(Iface):
    ...
    def get(self, auth_token, departemen_id):
        ...
        """
        self.send_get(auth_token, departemen_id)
        return self.recv_get()

    def send_get(self, auth_token, departemen_id):
        self._oprot.writeMessageBegin('get', TMessageType.CALL, self._seqid)
        args = get_args()
        args.auth_token = auth_token
        args.departemen_id = departemen_id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()
    ...
    def recv_get(self):
        ...
        if result.auth_error is not None:
            raise result.auth_error
        if result.departemen_error is not None:
            raise result.departemen_error
    ...
    def set_enabled(self, auth_token, departemen_id, enabled):
        ...
        """
        self.send_set_enabled(auth_token, departemen_id, enabled)
        self.recv_set_enabled()

    def send_set_enabled(self, auth_token, departemen_id, enabled):
    ...
    def set_name(self, auth_token, departemen_id, name):
        ...
        """
        self.send_set_name(auth_token, departemen_id, name)
        self.recv_set_name()

    def send_set_name(self, auth_token, departemen_id, name):
...
class Processor(Iface, TProcessor):
    ...
    def process_get(self, seqid, iprot, oprot):
        ...
        result = get_result()
        try:
            result.success = self._handler.get(args.auth_token, args.departemen_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except rpc.gen.user.auth.errors.ttypes.TAuthError as auth_error:
            msg_type = TMessageType.REPLY
            result.auth_error = auth_error
        except rpc.gen.data.departemen.errors.ttypes.TDepartemenError as departemen_error:
            msg_type = TMessageType.REPLY
            result.departemen_error = departemen_error
        except TApplicationException as ex:
            logging.exception('TApplication exception in handler')
            msg_type = TMessageType.EXCEPTION
            result = ex
    ...
    def process_set_enabled(self, seqid, iprot, oprot):
        ...
        result = set_enabled_result()
        try:
            self._handler.set_enabled(args.auth_token, args.departemen_id, args.enabled)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except rpc.gen.user.auth.errors.ttypes.TAuthError as auth_error:
    ...
    def process_set_name(self, seqid, iprot, oprot):
        ...
        result = set_name_result()
        try:
            self._handler.set_name(args.auth_token, args.departemen_id, args.name)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except rpc.gen.user.auth.errors.ttypes.TAuthError as auth_error:
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.query = rpc.gen.data.departemen.structs.ttypes.TDepartemenQuery()
...
fetch_args.thrift_spec = (
    ...
    (2, TType.STRUCT, 'query', [rpc.gen.data.departemen.structs.ttypes.TDepartemenQuery, None], None, ),  # 2
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = rpc.gen.data.departemen.structs.ttypes.TDepartemen()
                        _elem5.read(iprot)
...
fetch_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [rpc.gen.data.departemen.structs.ttypes.TDepartemen, None], False), None, ),  # 0
...
class get_args(object):
    ...
    def __init__(self, auth_token=None, departemen_id=None,):
        self.auth_token = auth_token
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.departemen_id = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.auth_token is not None:
            ...
            oprot.writeString(self.auth_token.encode('utf-8') if sys.version_info[0] == 2 else self.auth_token)
            oprot.writeFieldEnd()
        if self.departemen_id is not None:
            oprot.writeFieldBegin('departemen_id', TType.I32, 2)
            oprot.writeI32(self.departemen_id)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
get_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'auth_token', 'UTF8', None, ),  # 1
    (2, TType.I32, 'departemen_id', None, None, ),  # 2
)
...
class get_result(object):
    ...
    def __init__(self, success=None, auth_error=None, departemen_error=None,):
        self.success = success
        self.auth_error = auth_error
        self.departemen_error = departemen_error
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = rpc.gen.data.departemen.structs.ttypes.TDepartemen()
                ...
                if ftype == TType.STRUCT:
                    self.departemen_error = rpc.gen.data.departemen.errors.ttypes.TDepartemenError.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.auth_error is not None:
            ...
            self.auth_error.write(oprot)
            oprot.writeFieldEnd()
        if self.departemen_error is not None:
            oprot.writeFieldBegin('departemen_error', TType.STRUCT, 2)
            self.departemen_error.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
get_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [rpc.gen.data.departemen.structs.ttypes.TDepartemen, None], None, ),  # 0
    (1, TType.STRUCT, 'auth_error', [rpc.gen.user.auth.errors.ttypes.TAuthError, None], None, ),  # 1
    (2, TType.STRUCT, 'departemen_error', [rpc.gen.data.departemen.errors.ttypes.TDepartemenError, None], None, ),  # 2
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.form = rpc.gen.data.departemen.structs.ttypes.TDepartemenForm()
...
create_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'auth_token', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'form', [rpc.gen.data.departemen.structs.ttypes.TDepartemenForm, None], None, ),  # 2
)
...
class set_enabled_args(object):
    ...
    def __init__(self, auth_token=None, departemen_id=None, enabled=None,):
        self.auth_token = auth_token
        self.departemen_id = departemen_id
...
class set_enabled_result(object):
    ...
    def __init__(self, auth_error=None, departemen_error=None,):
        self.auth_error = auth_error
        self.departemen_error = departemen_error
...
class set_name_args(object):
    ...
    def __init__(self, auth_token=None, departemen_id=None, name=None,):
        self.auth_token = auth_token
        self.departemen_id = departemen_id
        self.name = name
